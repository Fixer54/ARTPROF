	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php echo 'Features and maintenance' ; ?></h4>
						<p><?php echo 'This update is mostly focussed towards features and maintenance. We have added several new features and improvements in the theme.'; ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-8/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'User Guided Tours / Walk Through', 'vibe' ); ?></h4>
						<p><?php _e( 'User guided tours are now available for users. We\'ll be adding more guided tours in the updates to come. Checkout the tutorial below.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/user-guided-tours-walkthrough" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'User Guided Tours', 'vibe' ); ?></h4>
						<p><img src="https://i.gyazo.com/15e37649f88ba71c2f7d8efc7e836699.gif" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/user-guided-tours-walkthrough" target="_blank" class="button">Tutorial</a>
					</div>
					<div>
						<h4><?php _e( 'Demo 7', 'vibe' ); ?></h4>
						<p style="max-height: 230px; overflow: hidden;"><img src="http://themes.vibethemes.com/wplms/wp-content/uploads/2016/06/demo7-310x573.jpg" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Demo 8', 'vibe' ); ?></h4>
						<p style="max-height: 230px; overflow: hidden;"><img src="http://themes.vibethemes.com/wplms/wp-content/uploads/2016/06/demo8-310x577.jpg" /></p>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Countdown Timers', 'vibe' ); ?></h4>
						<p style="max-height: 190px; overflow: hidden; border-bottom: 1px solid #eee;"><img src="https://i.gyazo.com/5fdc7c9a4fc91bdae2fe1ecdb0298485.gif" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/featured-courses" target="_blank" class="button">Tutorial</a>
					</div>
					<div>
						<h4><?php _e( 'Share certificates', 'vibe' ); ?></h4>
						<p style="max-height: 270px; overflow: hidden;"><img src="http://image.prntscr.com/image/0c5255de3c224452a0377cec9a7f7228.png" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Google Captcha in registration', 'vibe' ); ?></h4>
						<p style="max-height: 270px; overflow: hidden;"><img src="http://image.prntscr.com/image/555857e9f27e42f6a20e68f9ee8e316d.png" /></p>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Course News management via Front end', 'vibe' ); ?></h4>
						<p style="max-height: 182px; overflow: hidden; border-bottom: 1px solid #eee;"><img src="http://image.prntscr.com/image/5db171ad042b4bf695a43c4eef10dc30.png" /></p>
					</div>
					<div>
						<h4><?php _e( 'Quiz marks', 'vibe' ); ?></h4>
						<p style="max-height: 270px; overflow: hidden;"><img src="https://i.gyazo.com/bdcb88c407b0ebd58ff5f8f774f6c8af.gif" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Course Creation improvements', 'vibe' ); ?></h4>
						<p style="max-height: 270px; overflow: hidden;"><img src="https://i.gyazo.com/e68159fcd4a2e70bed3e4f8b1f14fd37.gif" /></p>
					</div>
				</div>
			</div>
			<div class="changelog">
